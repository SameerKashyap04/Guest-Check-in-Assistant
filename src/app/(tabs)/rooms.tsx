...
export default function RoomsScreen() {
    ...
    switch (status) {
      ...
      case 'occupied':
        return {
          ...
          icon: <UserCheck size={16} color="#0EA5E9" />,
          accentColor: '#0EA5E9',
        };
      case 'cleaning':
        return {
      ...
      case 'maintenance':
        return {
          ...
          icon: <Wrench size={16} color="#F43F5E" />,
          accentColor: '#F43F5E',
        };
      default:
        return {
          ...
          icon: <BedDouble size={16} color="#6B7280" />,
          accentColor: '#6B7280',
        };
    }
  };
  ...
  const handleSave = async () => {
    ...
    if (editingRoom) {
      await editRoom(editingRoom.id, roomNumber, roomType, roomStatus);
    } else {
      await createRoom(roomNumber, roomType, roomStatus);
    }
    closeSheet();
  };
        ...
        <GlassCard variant="elevated" className="p-4 rounded-2xl border border-gray-100 dark:border-white/10 flex-row justify-between items-center">
          <View className="flex-row items-center space-x-3 gap-3">
            ...
            <View>
              ...
              <Text className="text-xs text-gray-400 font-medium mt-0.5">{item.room_type || 'Standard Room'}</Text>
            </View>
          </View>
