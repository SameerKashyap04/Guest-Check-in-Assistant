    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-3xl p-8 max-w-md w-full shadow-2xl">
        <div className="items-center text-center mb-6">
          <div className="w-14 h-14 bg-rose-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-rose-500/20">
            <Sparkles className="w-7 h-7 text-white" />
          </div>
          <span className="text-[10px] font-black tracking-widest text-rose-700 bg-rose-50 px-3 py-1 rounded-full uppercase border border-rose-200 inline-block mb-2">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 font-medium focus:outline-none focus:border-rose-500 focus:bg-white"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-rose-500 hover:bg-rose-600 active:scale-95 text-white font-bold text-sm py-3 rounded-xl transition-all shadow-md shadow-rose-500/20 cursor-pointer"
          >
